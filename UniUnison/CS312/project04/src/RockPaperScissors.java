...
public class RockPaperScissors {
    ...
    public static String welcome(Scanner console) {
        // Asks and return the name of the player.
    ...
    public static int askNumRounds(Scanner console, String name) {
        ...
        // Asks the user how many rounds the player wants to play and returns the
        // number.
     ...
     * Return: A string with player wins, computer wins, and draws separated by
     * spaces
     */
    public static String playRounds(Scanner console, RandomPlayer computer,
            String name, int numRounds) {

        // Initializing the Player, Computer, and draw Scores
        int playerScore = 0;
        int computerScore = 0;
        int draws = 0;
    ...
    /**
     * Purpose: Play a single round of rock-paper-scissors between the player and
     * computer
     * Parameters: console - Scanner object used to read player input
     * computer - RandomPlayer object that generates the computer's choice
     * name - the name of the player
     * Output: Print the player's choice, the computer's choice, and the round
     * outcome
    ...
    public static char playRound(Scanner console, RandomPlayer computer, String name) {
        // Prints the Choices the Player can pick
        ...
        // Gets the Decision of the Player and Computer
        int playerChoice = console.nextInt();
        int computerChoice = computer.getComputerChoice();

        // Converts the Player's Choice and Computer Choice into their String
        // Counterpart
        String playerStr = numHandToStringHand(playerChoice);
        String computerStr = numHandToStringHand(computerChoice);

        // Prints out the hands that each player throws
        System.out.println("Computer picked " + computerStr + ", " + name
                + " picked " + playerStr + ".");

        // Get the Results of the Round and Return Character Results for it to be
        // tabulated outside the method
        char result = checkPlayerWin(playerChoice, computerChoice);
        return result;
    }

    /**
     * Purpose: Convert a numeric choice into the corresponding string
     * representation
     * Parameters: num - the numeric value representing a hand (ROCK, PAPER,
     * SCISSORS)
     * Output: None
    ...
    public static char checkPlayerWin(int playerChoice, int computerChoice) {
        ...
        boolean playerWinConditionOne = playerChoice == ROCK && computerChoice == SCISSORS;
        boolean playerWinConditionTwo = playerChoice == SCISSORS && computerChoice == PAPER;
        boolean playerWinConditionThree = playerChoice == PAPER && computerChoice == ROCK;
    ...
    /**
     * Purpose: Print the message describing how the winning hand defeated the
     * losing hand
    ...
    /**
     * Purpose: Print the final results of the game including total rounds, wins,
     * losses, and draws
    ...
    public static void printResults(String name, int numOfRounds, String gameResults) {
        ...
        // Gets the Index of the Different Spaces in the gameResults variable
        int indexOne = gameResults.indexOf(" ");
        int indexTwo = gameResults.indexOf(" ", indexOne + 1);

        // Parse the gameResults string to get the playerScore, computerScore, and Draws
