 ...
 * UTEID: ph23434
 * 
 * Description: The Data Structure Represents the Math Matrix and has a list 
 *              of operations that could be used on normal matrixes.
 */
...
public class MathMatrix {
    ...
    public MathMatrix(int numRows, int numCols, int initialVal) {
        ...
        if (numRows <= 0 || numCols <= 0) {
            throw new IllegalArgumentException("Violation of precondition: "
                    + "MathMatrix Constructor neither the row or col parameter"
                    + " may equal or less than 0.");
        }
